...
export default function Login(props: PageProps<Extract<KcContext, { pageId: "login.ftl" }>, I18n>) {
    ...
    // Typ für SocialProvider lokal deklarieren, damit icon erkannt wird
    type SocialProvider = {
        loginUrl: string;
        alias: string;
        providerId: string;
            ...
            {enableWebAuthnConditionalUI && (
                <>
                    ...
                    <input
                        id={webAuthnButtonId}
                        type="button"
                        className={clsx(kcClsx("kcButtonClass", "kcButtonDefaultClass", "kcButtonBlockClass", "kcButtonLargeClass"), "rounded-lg")}
