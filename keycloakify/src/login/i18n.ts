...
const { useI18n, ofTypeI18n } = i18nBuilder
    ...
    .withCustomTranslations({
        ...
        en: {
            ...
            magicLinkSentInstructions: "We have sent a login link to your email address if a user account with that email address was found. Click the link in the email to log in.",
        ...
        cs: {
            ...
            magicLinkSentInstructions: "Zaslali jsme přihlašovací odkaz na vaši e-mailovou adresu, pokud byl nalezen uživatelský účet s touto e-mailovou adresou. Kliknutím na odkaz v e-mailu se přihlásíte.",
            ...
            magicLinkSentInstructions: "Olemme lähettäneet kirjautumislinkin sähköpostiosoitteeseesi, jos kyseisellä sähköpostiosoitteella löytyi käyttäjätili. Kirjaudu sisään napsauttamalla sähköpostin linkkiä.",
        ...
        sv: {
            ...
            magicLinkSentInstructions: "Vi har skickat en inloggningslänk till din e-postadress om ett användarkonto med den e-postadressen hittades. Klicka på länken i e-postmeddelandet för att logga in.",
        ...
        tr: {
            ...
            magicLinkSentInstructions: "E-posta adresinize bir giriş bağlantısı gönderdik, eğer bu e-posta adresine sahip bir kullanıcı hesabı bulunursa. Giriş yapmak için e-postadaki bağlantıya tıklayın.",
        ...
        "zh-CN": {
            ...
            magicLinkSentInstructions: "如果找到与该邮箱地址对应的用户帐户，我们已向您的邮箱地址发送登录链接。点击邮件中的链接即可登录。",
        ...
        ja: {
            ...
            magicLinkSentInstructions: "そのメールアドレスのユーザーアカウントが見つかった場合、メールアドレスにログインリンクを送信しました。メール内のリンクをクリックしてログインしてください。",
